...
public class WorldMapPanel extends MapPanel {
	...
	protected void initPanelLinks() {
		...
		panelLinks = new PanelLink[] { new PanelLink(loopyLaneShape, loopyLaneHoverImage, 5),
				new PanelLink(punchlinePlaceShape, punchlinePlaceHoverImage, 6),
				new PanelLink(sillyStreetShape, sillyStreetHoverImage, 4),
				new PanelLink(barnacleBoulevardShape, barnacleBoulevardHoverImage, 1),
				new PanelLink(lighthouseLaneShape, lighthouseLaneHoverImage, 3),
				new PanelLink(new Shape[] { seaweedStreetShape1, seaweedStreetShape2 },
						seaweedStreetHoverImage, 2),
				new PanelLink(elmStreetShape, elmStreetHoverImage, 13),
				new PanelLink(new Shape[] { mapleStreetShape1, mapleStreetShape2 },
						mapleStreetHoverImage, 14),
				new PanelLink(oakStreetShape, oakStreetHoverImage, 15),
				new PanelLink(altoAvenueShape, altoAvenueHoverImage, 10),
				new PanelLink(sleetStreetShape, sleetStreetHoverImage, 8),
				...
				new PanelLink(walrusWayShape, walrusWayHoverImage, 7),
				new PanelLink(polarPlaceShape, polarPlaceHoverImage, 9),
